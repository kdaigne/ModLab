...
fprintf(fid_data,'%0.16g',To_Plot(45));fprintf(fid_data,'%s\n',' Internal Variable 0');
fprintf(fid_data,'%0.16g',To_Plot(46));fprintf(fid_data,'%s\n',' Internal Variable 1');
fprintf(fid_data,'%0.16g',To_Plot(47));fprintf(fid_data,'%s\n',' Internal Variable 2');
fprintf(fid_data,'%0.16g',To_Plot(48));fprintf(fid_data,'%s\n',' Internal Variable 3');
fprintf(fid_data,'%0.16g',To_Plot(49));fprintf(fid_data,'%s\n',' Internal Variable 4');
fprintf(fid_data,'%0.16g',To_Plot(50));fprintf(fid_data,'%s\n',' Internal Variable 5');
fprintf(fid_data,'%0.16g',To_Plot(51));fprintf(fid_data,'%s\n',' Internal Variable 6');
fprintf(fid_data,'%0.16g',To_Plot(52));fprintf(fid_data,'%s\n',' Internal Variable 7');
fprintf(fid_data,'%0.16g',To_Plot(53));fprintf(fid_data,'%s\n',' Internal Variable 8');
fprintf(fid_data,'%0.16g',To_Plot(54));fprintf(fid_data,'%s\n',' Internal Variable 9');
fprintf(fid_data,'%s\n',' ');
fprintf(fid_data,'%s\n',' ');
